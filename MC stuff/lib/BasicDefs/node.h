...
public:
	...
	Node(NodeType type, bool isExecutable, bool hasRedirect, bool hasSuggestionsType,
	...
	static varInt defaultCommandsCount;
	static Node* defaultCommands;
	static varInt defaultCommandsRootIndex;
};