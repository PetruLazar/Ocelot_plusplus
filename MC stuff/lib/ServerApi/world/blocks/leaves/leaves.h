...
{
protected:
	static bool placeLeaf(World* wld, int x, int y, int z, float curX, float curY, float curZ, BlockFace face, const BlockState& currentBlock, int base_id)
	{
		return false;
	}
...
public:
	...
	static bool place(World* wld, int x, int y, int z, float curX, float curY, float curZ, BlockFace face, const BlockState& currentBlock) { return placeLeaf(wld, x, y, z, curX, curY, curZ, face, currentBlock, base_id); }
